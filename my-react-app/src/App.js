...
function App() {
  return (
    <div className="App">
      ...
      <img src={cavernas} className="App-logo" alt="capa livro as cavernas de-aço" />
      <p>As Cavernas de Aço, de Isaac Asimov, é o primeiro romance da consagrada Série dos Robôs, uma das mais populares da ficção científica.
